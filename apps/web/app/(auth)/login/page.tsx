    ...
    <div className="min-h-screen flex items-center justify-center bg-inquest-base px-4 py-12">
      ...
      >
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 py-3.5 rounded-full border border-inquest-rule bg-white hover:bg-inquest-depth/30 transition-colors font-medium text-inquest-ink"
        >
